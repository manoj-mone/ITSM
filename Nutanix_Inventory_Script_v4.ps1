...
.NOTES
NAME: Nutanix_Inventory_Script_v4.ps1
VERSION: 1.0
Original AUTHORS: Kees Baggerman with help from Andrew Morgan, Michell Grauwman and Dave Brett
Modified By: Manoj Mone
Changes: VMuuid, Cluster UUID added; CSV File name renamed to use timestamp 
LASTEDIT: June 2021
#>
...
"VM Name"                       = $vm.vmName
"VM uuid"                       = $vm.uuid;
"Cluster Name"                  = $myvmdetail.status.cluster_reference.name
"Cluster UUID"                  = $myvmdetail.spec.cluster_reference.uuid
"Container"                     = $container
